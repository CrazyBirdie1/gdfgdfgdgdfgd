...
aria2c --enable-rpc --rpc-listen-all=false --rpc-listen-port 6800 --check-certificate=false\
   ...
   --bt-tracker="[$tracker_list]" --bt-max-peers=0 --bt-stop-timeout=600 --bt-tracker-connect-timeout=600 --seed-time=0.01 --min-split-size=10M --peer-id-prefix=-qB4201- --user-agent=qBittorrent/4.2.1 \
