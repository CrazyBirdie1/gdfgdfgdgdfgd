...
aria2c --enable-rpc --rpc-listen-all=false --rpc-listen-port 6800 --check-certificate=false\
   ...
   --bt-tracker="[$tracker_list]" --enable-dht=false --disable-ipv6=true --bt-max-peers=0 --seed-time=0.01 --bt-stop-timeout=600 --bt-tracker-connect-timeout=600 --min-split-size=10M --peer-id-prefix=-qB4205- --user-agent=qBittorrent/4.2.5 \
